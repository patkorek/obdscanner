...
import com.pat.obd_scanner.activity.ConfigActivity;
import com.pat.obd_scanner.activity.MainActivity;
import com.pat.obd_scanner.io.ObdCommandJob.ObdCommandJobState;
...
public class ObdGatewayService extends AbstractGatewayService {
    ...
    public void startService() throws IOException {
        ...
        if (remoteDevice == null || "".equals(remoteDevice)) {
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_starting), R.drawable.ic_launcher_background, true, true, false);
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_started), R.drawable.ic_launcher_background, true, true, false);
        }
    }
